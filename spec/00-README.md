...
**Not a replacement for `rucc-compat`.** The file-level corpora keep doing what they do. This repository takes over exactly one thing from it, which is the SQLite entry, because SQLite is a project and belongs where projects are. Document 07.8 specifies that migration.
